		 	...
		 	<form id="loginForm">
		 			<table>
				 		<tr>
				 			<td>用户名</td>
				 			<td>
				 				<input name="user_name" class="easyui-textbox" data-options="iconCls:'icon-search'"> 
				 			</td>
				 		</tr>
				 		<tr>
				 			<td>密码</td>
				 			<td>
				 				<input name="user_password" class="easyui-passwordbox" prompt="Password" iconWidth="28"> 
				 			</td>
				 		</tr>
				 		<tr>
				 			<td>验证码</td>
				 			<td>
				 				...
				 				<img id="yanzheng1" onclick="yanzheng()"  src="<%=request.getContextPath() %>/bank/yanzheng.do">
				 			</td>
				 		</tr>
				 	</table>
		 	</form>
...
<script type="text/javascript">
	function login(){
		$('#loginForm').form('submit', {    
		    url:"<%=request.getContextPath()%>/bank/login.do",    
	...
	function yanzheng(){
		$("#yanzheng1").prop("src","<%=request.getContextPath() %>/bank/yanzheng.do?"+new Date().getTime())
	}
</script>
</html>